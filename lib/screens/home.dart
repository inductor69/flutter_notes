          ...
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Icon(
                ...
                color: isFlagOn ? Colors.white : Colors.grey.shade600,
              ),
              decoration: BoxDecoration(
                  color: isFlagOn ? Colors.red.shade500 : Colors.transparent,
                  border: Border.all(
                    width: isFlagOn ? 2 : 1,
                    color:
                        isFlagOn ? Colors.red.shade500 : Theme.of(context).primaryColor,
                  ),
  ...
  Widget buildImportantIndicatorText() {
    return AnimatedCrossFade(
      ...
      firstChild: Padding(
        ...
        child: Text(
          'Showing Important notes'.toUpperCase(),
          style: TextStyle(
